...
@TODO:
1. Store images in RAM instead of writing to disk
...
NOTE: these results were from Randii. The current VGG models are /significantly/ improved. However, I do not want to update the README for them. Here's a taste of what the VGG models can do:

#+CAPTION: VGG 96 filters on clouds
[[file:readme_images/vgg_96_checkpoint_best_clouds.png]]

This is a 96 filter model, still decently early in training.
