...
[[file:readme_images/the_whole_agu_diagram.svg][Fancy Diagram. Admire it.]]

I spent so long (ten minutes) in my highly advanced vector-based graphics editor ([[excalidraw.io][Excalidraw]]) to make this beautiful graphic, so you better enjoy it.
...
We're maybe working on writing /another/ white paper to send to /Nature/. More to follow later.
