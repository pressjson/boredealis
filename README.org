...
Throw on some Philip Glass for this one.
...
I urge you to please keep the TUI available. It's easier to pass as flags rather than do every test as a drag and drop. Plus, SSH-ing into Ficus is so much easier than trying to use it as backend infra.
